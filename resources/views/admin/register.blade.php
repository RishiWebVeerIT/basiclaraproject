            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Cactus Fitness</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="post" action="{{route('save.register')}}" enctype='multipart/form-data'>
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="yourdesignation" class="form-label">Your Designation</label>
                      <input type="text" name="designation" class="form-control" id="yourdesignation"  value="{{ old('designation') }}" required>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" name="login" type="checkbox" value="1" id="acceptTerms">
                        <label class="form-check-label" for="acceptTerms">Auto Login</label>
                      </div>
                    </div>
                    <div class="col-12">
...
<script>
  swal('Invalid Credentials','{{Session::get('error')}}','error',{
    button:true,
    button:'OK',
  })
</script>
