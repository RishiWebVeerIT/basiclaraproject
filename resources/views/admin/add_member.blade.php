            ...
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" method="post" action="{{route('admin.create_member')}}" enctype='multipart/form-data'>
                ...
                <div class="col-md-8">
                  ...
                  <input type="text" class="form-control" name="name" id="inputName5" value="{{ old('name') }}" placeholder="Name">
                  @error('name')
                ...
                <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" id="inputMobile5" name="mobile" placeholder="Mobile" value="{{ old('mobile') }}">
                  @error('mobile')
                          <div class="text-danger">{{ $message }}</div>
                      @enderror
                </div>
                ...
                <div class="col-md-3">
                  ...
                  <input type="email" class="form-control" id="inputEmail5" name="email" placeholder="E-Mail ID" value="{{ old('email') }}">
                  @error('email')
                          <div class="text-danger">{{ $message }}</div>
                      @enderror
                </div>
